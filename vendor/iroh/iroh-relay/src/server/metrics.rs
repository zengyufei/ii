...
#[cfg_attr(feature = "metrics", metrics(name = "relayserver"))]
#[non_exhaustive]
pub struct Metrics {
    /*
    ...
    #[cfg_attr(feature = "metrics", metrics(help = "Number of bytes sent."))]
    ...
    #[cfg_attr(feature = "metrics", metrics(help = "Number of bytes received."))]
...
#[cfg_attr(feature = "metrics", derive(MetricsGroupSet))]
#[cfg_attr(feature = "metrics", metrics(name = "relay"))]
#[non_exhaustive]
